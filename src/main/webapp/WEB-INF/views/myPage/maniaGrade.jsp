...
<div style="display: flex;margin-top: 30px;">
	...
	<div style ="width: 73%">
		...
		<div class="myBlack" >
			<div style="width: 50%;">
				<div style="width: 80%; margin-left: 100px; text-align: left;">
					<p style="font-size: 35px;border-bottom: 3px solid #1391ff;color:white;">'${name }'님 환영합니다.</p>
				</div>
			</div>
		</div>
		...
		<div class="second_box_head" >
			...
			<div  style="float: right; font-size: 13px;margin-top: 15px;color: #888;">*최근 3개월간 완료된 주문에 대해서 주문건 수를 기준으로 매월 1일 매니아 등급에 반영됩니다.</div>
		</div>
