		...
		<div class="myBlack" >
			<div style="width: 50%;">
				<div style="width: 80%; margin-left: 100px; text-align: left;">
					<p style="font-size: 35px;border-bottom: 3px solid #1391ff;color:white;width:100%;">'${name }'님이 주문하신 내역입니다.</p>
						...
						<td width=100% >
							<table border=0 width=100% class="orderBox">
								...
								<tr>
									...
									<td colspan=2 class="aaa"><a href="/myPage/myOrderView_gift?order_uid=${order.order_uid }"> [e-coupon]상세 페이지 바로 가기</a></td>
								</tr>
							</table>
						</td>
					</tr>
