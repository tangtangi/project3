		...
		<td width=73% align=center height=700px>
			...
			<input name="user_id" value="${member.id }" type="hidden">
				<tr>
					...
					<td width=70%><input name="title" class="Cang"></td>
				</tr>
				<tr>
					<td width=30% height=200px>문의내용</td>
					<td width=70%><input name="content" type="text" class="Cang"></td>
				</tr>
				<tr>
				...
				<tr>
					<td  colspan=2 width=50% align=center  ><input type="submit" value="문의하기" class="receiveCoupon"></td>
				</tr>
			</form>
			</table>
		</td>
