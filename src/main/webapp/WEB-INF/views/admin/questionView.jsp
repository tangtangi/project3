		...
		<td width=73% align=center height=700px>
			<table width=50% align=center border=0 height=100% style="text-align:center;">
				...
				<tr>
					...
					<td width=70%><input type="text" class="Cang" value="${question.answer }" readonly></td> 
				</tr>
				<tr>
					<td></td>
					<td class="receiveCoupon"><a href="/admin/questionList" >목록으로</a></td>
				</tr>
			</table>
		</td>
		<td width=13.5%></td>
