...
<div style="display: flex;">
	...
	<div style ="width: 73%; text-align: center;display: flex;" >
		<div style ="width: 50%"><a href="#"><img src="/image/mainImage2-1.jpg"></a></div>
		<div style ="width: 50%"><a href="#"><img src="/image/mainImage2-2.jpg"></a></div>
...
<div style="display: flex; background:#f6f6f6;height: 430px;align-items: center; ">
	...
	<div style ="width: 73%; text-align: center;display: flex;" >
		<div style ="width: 33.3%; font-size: 34px;text-align: left;padding: 0 0 0 60px;">도미노피자의<br><span style="color: #238ece">특별한 매니아 혜택</span><br>누려보세요!<br>
			<button style="background: black;color: white;border-radius: 49%;width: 100px;height: 50px;outline: 0;">로그인</button>
		</div>
		<div style ="width: 66.6%" class="section">
			<div class="slideWrap">
				<ul class="slideList" >
					<li>
						<a href=""><img src="/image/mainImage3-1.jpg"></a>
					</li>
					<li>
						<a href=""><img src="/image/mainImage3-2.jpg"></a>
					</li>
					<li>
